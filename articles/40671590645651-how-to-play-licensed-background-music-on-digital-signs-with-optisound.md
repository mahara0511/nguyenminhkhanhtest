...
### **Step 1: Start Your 14-day Free Trial**
  ...
  1. Scroll down to OptiSound Music Add-On and select “Start Trial”
...
![](https://support.optisigns.com/hc/article_attachments/40674055498259)
  ...
  1. Click **Change** to browse through the list of available stations.


  1. Select the station that best fits your business environment.


  1. Ensure the **Audio Source Priority** is set to **Background Music** in the screen settings.


  1. Finish assigning any additional content to the screen as needed.  
  

  2. Click **Save** — the selected music station will begin playing immediately.  
