* Google Chrome Apps End-of-Support Timeline
  ...
  * Workaround 1: Webplayer on Google Admin Console

  * Workaround 2: Downloading OptiSigns from the Google Play Store

  * Workaround 3: Downloading OptiSigns APK from OptiSigns Website
